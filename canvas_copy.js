        ...
        if (currentResizer.classList.contains('bottom-right')) {          
          ...
          if(initial_right_border - diff_x >= 0 && threshold_r >= 0){
            ...
            if((initial_left_border + xlf) > ct_width || (initial_top_border + ylf) > ct_height){
              if(xa > ya){
                var b_w = Math.round(ct_height - initial_top_border - ((ya/xa)*(ct_width - initial_left_border)));
                if(b_w >=0){
                  bw_elem.style.borderRightWidth = '0px';      
                  bw_elem.style.borderBottomWidth = Math.round(b_w) + 'px';
                } else {
                  bw_elem.style.borderRightWidth = Math.round(ct_width - initial_left_border - ((xa/ya)*(ct_height - initial_top_border))) + 'px';      
                  bw_elem.style.borderBottomWidth = '0px';
                }
              } else {
                var r_w = Math.round(ct_width - initial_left_border - ((xa/ya)*(ct_height - initial_top_border)));
                if(r_w >=0){
                  bw_elem.style.borderRightWidth = r_w + 'px';      
                  bw_elem.style.borderBottomWidth = '0px';
                } else {
                  bw_elem.style.borderRightWidth = '0px';      
                  bw_elem.style.borderBottomWidth = Math.round(ct_height - initial_top_border - ((ya/xa)*(ct_width - initial_left_border))) + 'px';
                }   
              }
              return;
            }
            ...
            bw_elem.style.borderBottomWidth = b_br_updated + 'px';
              ...
              if(xa > ya){
                var b_w = ct_height - initial_top_border - ((ya/xa)*(ct_width - initial_left_border));
                if(b_w >=0){
                  bw_elem.style.borderRightWidth = '0px';      
                  bw_elem.style.borderBottomWidth = Math.round(b_w) + 'px';
                } else {
            ...
            bw_elem.style.borderBottomWidth = Math.round(ct_height - initial_top_border - min_height) + 'px';
            bw_elem.style.borderRightWidth = Math.round(ct_width - initial_left_border - min_width) + 'px';
          }
        } 
          ...
          if(initial_left_border + diff_x >= 0 && current_left_border >= 0 && threshold_x >=0){          
            ...
            if((initial_right_border + xlf) > ct_width || (initial_bottom_border + ylf) > ct_height){
              if(xa > ya){
                var t_w = Math.round(ct_height - initial_bottom_border - ((ya/xa)*(ct_width - initial_right_border)));
                console.log("h2",t_w);
                if(t_w >= 0){
                  bw_elem.style.borderLeftWidth = '0px';      
                  bw_elem.style.borderTopWidth = t_w + 'px';
                } else {
                  bw_elem.style.borderLeftWidth = Math.round(ct_width - initial_right_border - ((xa/ya)*(ct_height - initial_bottom_border))) + 'px';      
                  bw_elem.style.borderTopWidth = '0px';
                }
              } else {
                console.log("h2-33");
                var l_w = Math.round(ct_width - initial_right_border - ((xa/ya)*(ct_height - initial_bottom_border)));
                if(l_w >= 0){
                  bw_elem.style.borderLeftWidth = l_w + 'px';      
                  bw_elem.style.borderTopWidth = '0px';
                } else {
                  bw_elem.style.borderLeftWidth = '0px';      
                  bw_elem.style.borderTopWidth = Math.round(ct_height - initial_bottom_border - ((ya/xa)*(ct_width - initial_right_border))) + 'px';
                }    
              }
              return;
            }
          ...
          if(initial_right_border - diff_x >= 0 && threshold_r >= 0){
            ...
            r_br_updated = initial_right_border - diff_x;
            t_br_updated = (initial_top_border - (ylf - yli));
            console.log("-->>>>",initial_left_border + xlf);
            if((initial_left_border + xlf) > ct_width || (initial_bottom_border + ylf) > ct_height){
              if(xa > ya){
                var t_w = Math.round(ct_height - initial_bottom_border - ((ya/xa)*(ct_width - initial_left_border)));
                if(t_w >= 0){
                  bw_elem.style.borderRightWidth = '0px';      
                  bw_elem.style.borderTopWidth = t_w + 'px';
                } else {
                  bw_elem.style.borderRightWidth = Math.round(ct_width - initial_left_border - ((xa/ya)*(ct_height - initial_bottom_border))) + 'px';      
                  bw_elem.style.borderTopWidth = '0px';
                } 
              } else {
                var r_w = Math.round(ct_width - initial_left_border - ((xa/ya)*(ct_height - initial_bottom_border)));
                if(r_w >= 0){
                  bw_elem.style.borderRightWidth = r_w + 'px';      
                  bw_elem.style.borderTopWidth = '0px';
                } else {
                  bw_elem.style.borderRightWidth = '0px';      
                  bw_elem.style.borderTopWidth = Math.round(ct_height - initial_bottom_border - ((ya/xa)*(ct_width - initial_left_border))) + 'px';
                }
          ...
          if(initial_left_border + diff_x >= 0 && current_left_border >= 0 && threshold_x >=0){
            ...
            l_br_updated = (initial_left_border + diff_x);
            b_br_updated = (initial_bottom_border - (ylf - yli));
            if((initial_right_border + xlf) > ct_width || (initial_top_border + ylf) > ct_height){
              if(xa > ya){
                var b_w = Math.round(ct_height - initial_top_border - ((ya/xa)*(ct_width - initial_right_border)));
                console.log("h7",b_w);
                if(b_w >= 0){
                  bw_elem.style.borderLeftWidth = '0px';      
                  bw_elem.style.borderBottomWidth = b_w + 'px';
                } else {
                  bw_elem.style.borderLeftWidth = Math.round(ct_width - initial_right_border - ((xa/ya)*(ct_height - initial_top_border))) + 'px';      
                  bw_elem.style.borderBottomWidth = '0px';
                }
              } else {
                console.log("h7-23");
                var l_w = Math.round(ct_width - initial_right_border - ((xa/ya)*(ct_height - initial_top_border)));
                if(l_w >= 0){
                  bw_elem.style.borderLeftWidth = l_w + 'px';      
                  bw_elem.style.borderBottomWidth = '0px';
                } else {
                  bw_elem.style.borderLeftWidth = '0px';      
                  bw_elem.style.borderBottomWidth = Math.round(ct_height - initial_top_border - ((ya/xa)*(ct_width - initial_right_border))) + 'px';
                }    
              }
              return;
            }
